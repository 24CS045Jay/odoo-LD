...
export type ApiSection = { _id: string; id?: string; city: string; title?: string; startDate?: string; endDate?: string; budget?: number; orderIndex: number; activities?: ApiItineraryActivity[] };
...
export type ApiCalendarEvent = { id: string; title: string; startDate?: string; endDate?: string; status: string; type: string };
